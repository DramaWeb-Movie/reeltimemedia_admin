      ...
      <div className="flex flex-col lg:flex-row gap-6">
        <div className="lg:w-64 flex-shrink-0">
          <Card className="text-center">
            <div className="w-20 h-20 rounded-full bg-slate-700 mx-auto flex items-center justify-center text-2xl font-bold text-slate-300">
          ...
          <Card>
            ...
            <dl className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
              ...
              <div>
                ...
                <dd className="text-white">{user.subscription_status}</dd>
              </div>
              <div>
